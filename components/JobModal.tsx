            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6 bg-gray-50 rounded-xl p-4">
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1 text-gray-400 text-xs mb-1"><Users className="w-3.5 h-3.5" /> Applicants</div>
                  <div className="font-bold text-[#141719] text-lg">{job.applicants}</div>
                </div>
                <div className="text-center border-x border-gray-200">
                  <div className="flex items-center justify-center gap-1 text-gray-400 text-xs mb-1"><Eye className="w-3.5 h-3.5" /> Views</div>
                  <div className="font-bold text-[#141719] text-lg">{thousands(job.views)}</div>
                </div>
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1 text-gray-400 text-xs mb-1"><Calendar className="w-3.5 h-3.5" /> Deadline</div>
              ...
              <AnimatePresence mode="wait">
                {submitted ? (
                  <motion.div
                    key="success"
                    className="bg-[#f0f7f1] border border-[#bbdbbf] rounded-xl p-6 text-center"
                  ...
                  >
                    ...
                    <div className="mb-5">
                      ...
                      <textarea
                        required rows={4} placeholder="Tell us why you're the perfect fit for this role..."
